...
function _oot_logic()
	...
	function can_play_tp_fire()
		return has_ocarina() or has('SHARED_OCARINA') and ('SONG_TP_FIRE') and has_('OOT_BUTTON_A') and ('OOT_BUTTON_C-DOWN') and ('OOT_BUTTON_C-RIGHT')
	end

	function can_play_tp_water()
		return has_ocarina() or has('SHARED_OCARINA') and ('SONG_TP_WATER') and has_('OOT_BUTTON_C-DOWN') and ('OOT_BUTTON_C-LEFT') and ('OOT_BUTTON_C-RIGHT') and ('OOT_BUTTON_A')
	end
	...
	function can_play_tp_spirit()
		return has_ocarina() or has('SHARED_OCARINA') and ('SONG_TP_SPIRIT') and has_('OOT_BUTTON_C-DOWN') and ('OOT_BUTTON_A') and ('OOT_BUTTON_C-RIGHT')
	end
