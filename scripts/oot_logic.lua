...
function _oot_logic()
	...
	function can_play_sun()
		return has_ocarina() and ('SONG_SUN') and has_oot_button_c_up() and has_oot_button_c_down() and has_oot_button_c_right()
	end

	function can_play_time()
		return has_ocarina() and ('SONG_TIME') and has_oot_button_c_down() and has_oot_button_a() and has_oot_button_c_right()
	end

	function can_play_epona()
		return has_ocarina() and ('SONG_EPONA') and has_oot_button_c_up() and has_oot_button_c_left() and has_oot_button_c_right()
	end

	function can_play_storms()
		return has_ocarina() and ('SONG_STORMS') and has_oot_button_c_up() and has_oot_button_c_down() and has_oot_button_a()
	end

	function can_play_zelda()
		return has_ocarina() and ('SONG_ZELDA') and has_oot_button_c_up() and has_oot_button_c_left() and has_oot_button_c_right()
	end

	function can_play_saria()
		return has_ocarina() and ('SONG_SARIA') and has_oot_button_c_down() and has_oot_button_c_left() and has_oot_button_c_right()
	end

	function can_play_elegy()
		return has_ocarina() and ('SONG_EMPTINESS') and has_oot_button_c_up() and has_oot_button_c_down() and has_oot_button_c_left() and has_oot_button_c_right()
	end

	function can_play_tp_light() 
		return has_ocarina() and ('SONG_TP_LIGHT') and has_oot_button_c_up() and has_oot_button_c_left() and has_oot_button_c_right()
	end

	function can_play_tp_forest()
		return has_ocarina() and ('SONG_TP_FOREST') and has_oot_button_c_up() and has_oot_button_a() and has_oot_button_c_left() and has_oot_button_c_right()
	end

	function can_play_tp_fire()
		return has_ocarina() and ('SONG_TP_FIRE') and has_oot_button_a() and has_oot_button_c_down() and has_oot_button_c_right()
	end

	function can_play_tp_water()
		return has_ocarina() and ('SONG_TP_WATER') and has_oot_button_c_down() and has_oot_button_c_left() and has_oot_button_c_right() and has_oot_button_a()
	end

	function can_play_tp_shadow()
		return has_ocarina() and ('SONG_TP_SHADOW') and has_oot_button_a() and has_oot_button_c_down() and has_oot_button_c_left() and has_oot_button_c_right()
	end

	function can_play_tp_spirit()
		return has_ocarina() and ('SONG_TP_SPIRIT') and has_oot_button_c_down() and has_oot_button_a() and has_oot_button_c_right()
	end
	...
	function has_small_key_gerudo()
		return setting('gerudoFortress', 'open') or cond(setting('gerudoFortress', 'single'), has('SMALL_KEY_GF', 1), has('SMALL_KEY_GF', 4)) or has_skeleton_key_oot()
	end

	function can_rescue_carpenter()
		return has_small_key_gerudo() or has_skeleton_key_oot() and (has_weapon() or ((can_boomerang() or has_nuts()) and can_use_sticks()))
	end
	...
	function has_fire_spirit()
		return has_magic() and (has_arrows() and (has('ARROW_FIRE') or has('SHARED_ARROW_FIRE')) and has_sticks() or has('SPELL_FIRE')) and (has_explosives() or has_skeleton_key_oot() or small_keys(SMALL_KEY_SPIRIT, 2))
	end
	...
	function has_small_keys_fire(x)
		return setting('smallKeyShuffleOot', 'removed') or cond(setting('smallKeyShuffleOot', 'anywhere'), has('SMALL_KEY_FIRE', x + 1), has('SMALL_KEY_FIRE', x) or has_skeleton_key_oot())
	end
    ...
    ["Bottom of the Well Main"] = {
	    ...
	    ["Bottom of the Well Underwater Heart"] = function () return can_play(SONG_ZELDA) end,
            ...
            ["Bottom of the Well Map"] = function () return has_explosives_or_hammer() or (has_bombflowers() and (small_keys(SMALL_KEY_BOTW, 3) or has_skeleton_key_oot() or can_use_din())) end,
            ["Bottom of the Well Coffin"] = function () return true end,
            ["Bottom of the Well Pits"] = function () return has_lens() and small_keys(SMALL_KEY_BOTW, 3) or has_skeleton_key_oot() end,
            ...
            ["Bottom of the Well GS East Cage"] = function () return small_keys(SMALL_KEY_BOTW, 3) or has_skeleton_key_oot() and has_lens() and can_boomerang() end,
    ...
    [" Basement"] = {
        ["exits"] = {
            [" Lobby"] = function () return true end,
        ...
        ["locations"] = {
            ...
            ["Deku Tree Lobby Grass"] = function () return can_cut_grass() end,
	    ["Deku Tree Slingshot Grass"] = function () return can_cut_grass() end,	
	    ["Deku Tree Basement Grass"] = function () return can_cut_grass() end,		
    ...
    ["Fire Temple"] = {
        ["exits"] = {
            ...
            ["Fire Temple Lava Room"] = function () return has_small_keys_fire(1) or has_skeleton_key_oot() end,
            ["Fire Temple Boss Key Loop"] = function () return cond(setting('smallKeyShuffleOot', 'anywhere'), small_keys(SMALL_KEY_FIRE, 8), true) or has_skeleton_key_oot() and can_hammer() end,
    ...
    ["Fire Temple Lava Room"] = {
        ["exits"] = {
            ["Fire Temple Maze"] = function () return is_adult() and has_small_keys_fire(3) or has_skeleton_key_oot() and has_tunic_goron_strict() and has('STRENGTH') and (has_ranged_weapon_adult() or has_explosives() or can_boomerang()) end,
        },
        ["locations"] = {
    ...
    ["Fire Temple Maze"] = {
        ["exits"] = {
            ["Fire Temple Maze Upper"] = function () return has_small_keys_fire(5) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
            ...
            ["Fire Temple Map"] = function () return can_use_bow() and has_small_keys_fire(4) or has_skeleton_key_oot() end,
        },
    },
    ["Fire Temple Maze Upper"] = {
        ["exits"] = {
            ["Fire Temple Ring"] = function () return has_small_keys_fire(6) or has_skeleton_key_oot() end,
    ...
    ["Fire Temple Ring"] = {
        ["exits"] = {
            ["Fire Temple Before Miniboss"] = function () return has_small_keys_fire(7) or has_skeleton_key_oot() end,
    ...
    ["Forest Temple Main"] = {
        ...
        ["exits"] = {
            ...
            ["Forest Temple Maze"] = function () return small_keys(SMALL_KEY_FOREST, 1) or has_skeleton_key_oot() end,
    ...
    ["Forest Temple Maze"] = {
        ["exits"] = {
            ...
            ["Forest Temple Twisted 1 Normal"] = function () return is_adult() and small_keys(SMALL_KEY_FOREST, 2) and has('STRENGTH') or has_skeleton_key_oot() and has('STRENGTH') end,
    ...
    ["Forest Temple Twisted 1 Normal"] = {
        ["exits"] = {
            ["Forest Temple Poe 1"] = function () return small_keys(SMALL_KEY_FOREST, 3) or has_skeleton_key_oot() end,
        },
    },
    ...
    ["Forest Temple Poe 2"] = {
        ...
        ["exits"] = {
            ["Forest Temple Twisted 2 Normal"] = function () return small_keys(SMALL_KEY_FOREST, 4) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Forest Temple Twisted 2 Normal"] = {
        ["exits"] = {
            ["Forest Temple Rotating Room"] = function () return small_keys(SMALL_KEY_FOREST, 5) or has_skeleton_key_oot() end,
        },
    },
    ...
    ["Ganon Castle Light"] = {
        ["events"] = {
            ["GANON_TRIAL_LIGHT"] = function () return small_keys(SMALL_KEY_GANON, 2) or has_skeleton_key_oot() and can_hookshot() and has_lens() and has_light_arrows() end,
        },
        ["locations"] = {
            ...
            ["Ganon Castle Light Chest Lullaby"] = function () return small_keys(SMALL_KEY_GANON, 1) or has_skeleton_key_oot() and can_play(SONG_ZELDA) end,
        },
    },
    ["Ganon Castle Forest"] = {
        ["events"] = {
    ...
    ["Gerudo Training Grounds Maze"] = {
        ["exits"] = {
            ["Gerudo Training Grounds Maze Side"] = function () return small_keys(SMALL_KEY_GTG, 9) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
            ["Gerudo Training Maze Upper Fake Ceiling"] = function () return small_keys(SMALL_KEY_GTG, 3) or has_skeleton_key_oot() and has_lens() end,
    ...
    ["Desert Colossus"] = {
	    ...
	    ["Oasis Fairy Fountain"] = function () return can_play_storms() end,
        },
    },
    ...
    ["Fairy Fountain Nayru"] = {
        ...
        ["locations"] = {
            ["Great Fairy Nayru's Love"] = function () return  end,
        },
    },
    ...
    ["Shadow Temple Main"] = {
        ["exits"] = {
            ["Shadow Temple Open"] = function () return small_keys(SMALL_KEY_SHADOW, 1) or has_skeleton_key_oot() and has_explosives() end,
        },
        ["locations"] = {
    ...
    ["Shadow Temple Open"] = {
        ["exits"] = {
            ["Shadow Temple Wind"] = function () return small_keys(SMALL_KEY_SHADOW, 3) or has_skeleton_key_oot() and can_hookshot() and has_lens() end,
        },
        ["locations"] = {
            ...
            ["Shadow Temple Invisible Spike Room"] = function () return small_keys(SMALL_KEY_SHADOW, 2) or has_skeleton_key_oot() and can_hookshot() and has_lens() end,
            ["Shadow Temple Skull"] = function () return small_keys(SMALL_KEY_SHADOW, 2) or has_skeleton_key_oot() and can_hookshot() and has_bombflowers() and has_lens() end,
            ["Shadow Temple GS Skull Pot"] = function () return small_keys(SMALL_KEY_SHADOW, 2) or has_skeleton_key_oot() and can_hookshot() and has_lens() end,
    ...
    ["Shadow Temple Wind"] = {
        ["exits"] = {
            ["Shadow Temple Boat"] = function () return small_keys(SMALL_KEY_SHADOW, 4) or has_skeleton_key_oot() and can_play(SONG_ZELDA) end,
        },
        ["locations"] = {
	    ...
	    ["Shadow Temple After Wind Room Big Fairy"] = function () return can_play_sun() end,
            ...
            ["Shadow Temple GS Near Boat"] = function () return small_keys(SMALL_KEY_SHADOW, 4) or has_skeleton_key_oot() and can_longshot() end,
        },
    },
    ["Shadow Temple Boat"] = {
        ["exits"] = {
            ["Shadow Temple Boss"] = function () return small_keys(SMALL_KEY_SHADOW, 5) or has_skeleton_key_oot() and boss_key(BOSS_KEY_SHADOW) and (can_use_bow() or scarecrow_longshot()) end,
        },
        ["locations"] = {
    ...
    ["Spirit Temple"] = {
        ["events"] = {
            ["SPIRIT_CHILD_DOOR"] = function () return is_child() and small_keys(SMALL_KEY_SPIRIT, 5) or has_skeleton_key_oot() end,
            ["SPIRIT_ADULT_DOOR"] = function () return small_keys(SMALL_KEY_SPIRIT, 3) or has_skeleton_key_oot() and can_lift_silver() end,
            ["MAGIC"] = function () return true end,
        },
        ["exits"] = {
    ...
    ["Spirit Temple Child Entrance"] = {
        ["exits"] = {
            ...
            ["Spirit Temple Child Climb"] = function () return is_child() and small_keys(SMALL_KEY_SPIRIT, 1) or has_skeleton_key_oot() end,
    ...
    ["Spirit Temple Child Climb"] = {
        ["exits"] = {
            ["Spirit Temple Child Entrance"] = function () return is_child() and small_keys(SMALL_KEY_SPIRIT, 1) or has_skeleton_key_oot() end,
    ...
    ["Spirit Temple Child Upper"] = {
        ["exits"] = {
            ...
            ["Spirit Temple Child Hand"] = function () return small_keys(SMALL_KEY_SPIRIT, 5) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
            ["Spirit Temple Sun Block Room Torches"] = function () return event('SPIRIT_CHILD_DOOR') and can_use_sticks() and has_explosives() or has_fire_spirit() or (has_fire_arrows() and small_keys(SMALL_KEY_SPIRIT, 4)) or has_skeleton_key_oot() end,
    ...
    ["Spirit Temple Child Hand"] = {
        ["exits"] = {
            ["Spirit Temple Child Upper"] = function () return small_keys(SMALL_KEY_SPIRIT, 5) or has_skeleton_key_oot() end,
            ["Desert Colossus"] = function () return true end,
        },
        ["locations"] = {
    ...
    ["Spirit Temple Adult Entrance"] = {
        ["exits"] = {
            ["Spirit Temple Adult Climb"] = function () return small_keys(SMALL_KEY_SPIRIT, 1) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Spirit Temple Statue"] = {
        ...
        ["locations"] = {
            ["Spirit Temple Statue Base"] = function () return event('SPIRIT_CHILD_DOOR') and has_explosives() and can_use_sticks() or has_fire_spirit() or (has_fire_arrows() and small_keys(SMALL_KEY_SPIRIT, 4)) or has_skeleton_key_oot() end,
            ...
            ["Spirit Temple Silver Gauntlets"] = function () return small_keys(SMALL_KEY_SPIRIT, 3) or has_skeleton_key_oot() and has_hookshot(2) and has_explosives() end,
        },
    },
    ["Spirit Temple Statue Adult"] = {
        ["exits"] = {
            ["Spirit Temple Statue"] = function () return true end,
            ["Spirit Temple Adult Upper"] = function () return small_keys(SMALL_KEY_SPIRIT, 4) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Spirit Temple Adult Upper"] = {
        ["exits"] = {
            ...
            ["Spirit Temple Adult Climb 2"] = function () return small_keys(SMALL_KEY_SPIRIT, 5) or has_skeleton_key_oot() end,
        },
    },
    ...
    ["Water Temple Main"] = {
        ["exits"] = {
            ...
            ["Water Temple Center Bottom"] = function () return event('WATER_LEVEL_LOW') and small_keys(SMALL_KEY_WATER, 5) or has_skeleton_key_oot() end,
            ...
            ["Water Temple Elevator"] = function () return small_keys(SMALL_KEY_WATER, 5) or has_skeleton_key_oot() and can_hookshot() or can_use_bow() or can_use_din() end,
            ...
            ["Water Temple Waterfalls"] = function () return has_tunic_zora() and small_keys(SMALL_KEY_WATER, 4) or has_skeleton_key_oot() and can_longshot() and (has_iron_boots() or event('WATER_LEVEL_LOW')) end,
            ["Water Temple Large Pit"] = function () return small_keys(SMALL_KEY_WATER, 4) or has_skeleton_key_oot() and event('WATER_LEVEL_RESET') end,
    ...
    ["Water Temple Waterfalls Ledge"] = {
        ["exits"] = {
            ["Water Temple Boss Key Room"] = function () return small_keys(SMALL_KEY_WATER, 5) or has_skeleton_key_oot() and can_dive_small() end,
        },
        ["locations"] = {
    ...
    ["Water Temple Large Pit"] = {
        ["exits"] = {
            ["Water Temple Before Dark Link"] = function () return small_keys(SMALL_KEY_WATER, 5) or has_skeleton_key_oot() and can_hookshot() end,
        },
        ["locations"] = {
    ...
    ["Fire Temple"] = {
        ["exits"] = {
            ...
            ["Fire Temple Vanilla Hammer Loop"] = function () return small_keys(SMALL_KEY_FIRE, 5) or has_skeleton_key_oot() and has_weapon() and (has_bombs() or can_hammer() or can_hookshot()) end,
        },
        ["locations"] = {
    ...
    ["Fire Temple 1f Lava Room"] = {
        ["exits"] = {
            ["Fire Temple Upper Lobby"] = function () return true end,
            ["Fire Temple Maze Lower"] = function () return has_tunic_goron_strict() and small_keys(SMALL_KEY_FIRE, 2) or has_skeleton_key_oot() and has_fire() end,
        },
        ["locations"] = {
    ...
    ["Fire Temple Maze Upper"] = {
        ["exits"] = {
            ...
            ["Fire Temple 3f Lava Room"] = function () return small_keys(SMALL_KEY_FIRE, 3) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Fire Temple Fire Walls"] = {
        ...
        ["exits"] = {
            ["Fire Temple Top"] = function () return small_keys(SMALL_KEY_FIRE, 4) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Fire Temple Top"] = {
        ["locations"] = {
            ...
            ["MQ Fire Temple GS Topmost"] = function () return small_keys(SMALL_KEY_FIRE, 5) or has_skeleton_key_oot() end,
        },
    },
    ["Forest Temple"] = {
        ["exits"] = {
    ...
    ["Forest Temple West Wing"] = {
        ["exits"] = {
            ...
            ["Forest Temple Straightened Hallway"] = function () return small_keys(SMALL_KEY_FOREST, 3) or has_skeleton_key_oot() and is_adult() and has('STRENGTH') end,
            ["Forest Temple West Garden"] = function () return small_keys(SMALL_KEY_FOREST, 2) or has_skeleton_key_oot() and is_adult() and has('STRENGTH') end,
            ["Forest Temple Twisted Hallway"] = function () return small_keys(SMALL_KEY_FOREST, 3) or has_skeleton_key_oot() and is_adult() and has('STRENGTH') and event('FOREST_TWIST_SWITCH') end,
        },
        ["locations"] = {
    ...
    ["Forest Temple Twisted Hallway"] = {
        ["exits"] = {
            ["Forest Temple Bow Region"] = function () return small_keys(SMALL_KEY_FOREST, 4) or has_skeleton_key_oot() end,
        },
    },
    ["Forest Temple Bow Region"] = {
        ...
        ["exits"] = {
            ["Forest Temple Falling Ceiling"] = function () return small_keys(SMALL_KEY_FOREST, 5) or has_skeleton_key_oot() and (can_use_bow() or can_use_din()) end,
        },
        ["locations"] = {
    ...
    ["Forest Temple Falling Ceiling"] = {
        ["events"] = {
            ["FOREST_POE_3"] = function () return small_keys(SMALL_KEY_FOREST, 6) or has_skeleton_key_oot() and can_use_bow() end,
        },
        ["locations"] = {
    ...
    ["Ganon Castle Light"] = {
        ["events"] = {
            ["GANON_TRIAL_LIGHT"] = function () return has_light_arrows() and has_lens() and can_hookshot() and small_keys(SMALL_KEY_GANON, 3) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Ganon Castle Water"] = {
        ["events"] = {
            ...
            ["GANON_TRIAL_WATER"] = function () return has_blue_fire() and small_keys(SMALL_KEY_GANON, 3) or has_skeleton_key_oot() and has_light_arrows() end,
        },
        ["locations"] = {
    ...
    ["Gerudo Training Grounds"] = {
        ["events"] = {
            ...
            ["GTG_ICE_ARROWS"] = function () return small_keys(SMALL_KEY_GTG, 3) or has_skeleton_key_oot() and can_hammer() end,
        },
        ["exits"] = {
            ["Gerudo Fortress Exterior"] = function () return true end,
    ...
    ["Shadow Temple Truth Spinner"] = {
        ...
        ["exits"] = {
            ["Shadow Temple First Locked Door"] = function () return has_explosives() and small_keys(SMALL_KEY_SHADOW, 6) or has_skeleton_key_oot() end,
    ...
    ["Shadow Temple First Beamos"] = {
        ["exits"] = {
            ["Shadow Temple Upper Huge Pit"] = function () return has_explosives() and small_keys(SMALL_KEY_SHADOW, 2) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Shadow Temple Lower Huge Pit"] = {
        ["exits"] = {
            ["Shadow Temple Invisible Spike Floor"] = function () return small_keys(SMALL_KEY_SHADOW, 3) or has_skeleton_key_oot() and has_hover_boots() end,
        },
        ["locations"] = {
    ...
    ["Shadow Temple Invisible Spike Floor"] = {
        ["exits"] = {
            ["Shadow Temple Wind Tunnel"] = function () return small_keys(SMALL_KEY_SHADOW, 4) or has_skeleton_key_oot() and can_hookshot() end,
        },
        ["locations"] = {
    ...
    ["Shadow Temple Wind Tunnel"] = {
        ["exits"] = {
            ["Shadow Temple Boat"] = function () return small_keys(SMALL_KEY_SHADOW, 5) or has_skeleton_key_oot() and can_play(SONG_ZELDA) end,
        },
        ["locations"] = {
    ...
    ["Shadow Temple Final Side Rooms"] = {
        ["locations"] = {
            ...
            ["MQ Shadow Temple Boss Key Chest"] = function () return small_keys(SMALL_KEY_SHADOW, 6) or has_skeleton_key_oot() and can_use_din() end,
            ["MQ Shadow Temple Crushing Wall Left Chest"] = function () return small_keys(SMALL_KEY_SHADOW, 6) or has_skeleton_key_oot() and can_use_din() end,
        },
    },
    ["Shadow Temple Boat"] = {
        ["exits"] = {
    ...
    ["Spirit Temple Child Side"] = {
        ["exits"] = {
            ["Spirit Temple Child Upper"] = function () return has_explosives() and small_keys(SMALL_KEY_SPIRIT, 6) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Spirit Temple Child Upper"] = {
        ...
        ["exits"] = {
            ["Spirit Temple Statue"] = function () return small_keys(SMALL_KEY_SPIRIT, 7) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Spirit Temple Statue"] = {
        ...
        ["exits"] = {
            ["Spirit Temple Child Upper"] = function () return small_keys(SMALL_KEY_SPIRIT, 7) or has_skeleton_key_oot() end,
            ...
            ["Spirit Temple Adult Upper"] = function () return is_adult() and small_keys(SMALL_KEY_SPIRIT, 5) or has_skeleton_key_oot() end,
    ...
    ["Spirit Temple Sun Block Room"] = {
        ["exits"] = {
            ["Spirit Temple Child Hand"] = function () return small_keys(SMALL_KEY_SPIRIT, 7) or has_skeleton_key_oot() and (has_weapon() or can_use_sticks()) or (is_adult() and small_keys(SMALL_KEY_SPIRIT, 4) or has_skeleton_key_oot() and has_lens() and can_play_time()) end,
        },
        ["locations"] = {
    ...
    ["Spirit Temple Adult Lower"] = {
        ["locations"] = {
            ...
            ["MQ Spirit Temple Symphony Room Chest"] = function () return small_keys(SMALL_KEY_SPIRIT, 7) or has_skeleton_key_oot() and can_hammer() and can_play_time() and can_play_epona() and can_play_sun() and can_play_storms() and can_play(SONG_ZELDA) end,
            ["MQ Spirit Temple GS Leever Room"] = function () return true end,
            ["MQ Spirit Temple GS Symphony Room"] = function () return small_keys(SMALL_KEY_SPIRIT, 7) or has_skeleton_key_oot() and can_hammer() and can_play_time() and can_play_epona() and can_play_sun() and can_play_storms() and can_play(SONG_ZELDA) end,
	    ["MQ Spirit Temple Fairy Symphony Room"] = function () return small_keys(SMALL_KEY_SPIRIT, 7) or has_skeleton_key_oot() and can_hammer() and can_play_time() and can_play_epona() and can_play_sun() and can_play_storms() and can_play(SONG_ZELDA) end,
    ...
    ["Spirit Temple Adult Upper"] = {
        ["exits"] = {
            ...
            ["Spirit Temple Top Floor"] = function () return small_keys(SMALL_KEY_SPIRIT, 6) or has_skeleton_key_oot() end,
        },
        ["locations"] = {
    ...
    ["Spirit Temple Top Floor"] = {
        ...
        ["locations"] = {
            ...
            ["MQ Spirit Temple GS Top Floor Left Wall"] = function () return small_keys(SMALL_KEY_SPIRIT, 7) or has_skeleton_key_oot() end,
            ["MQ Spirit Temple GS Top Floor Back Wall"] = function () return small_keys(SMALL_KEY_SPIRIT, 7) or has_skeleton_key_oot() end,
        },
    },
    ["Water Temple"] = {
        ["exits"] = {
    ...
    ["Water Temple Main"] = {
        ...
        ["exits"] = {
            ["Water Temple"] = function () return true end,
            ["Water Temple Dark Link"] = function () return small_keys(SMALL_KEY_WATER, 1) or has_skeleton_key_oot() and event('WATER_LEVEL_HIGH') and can_longshot() end,
    ...
    ["Water Temple Side Loop"] = {
        ["locations"] = {
            ...
            ["MQ Water Temple GS Side Loop"] = function () return has_fire() and small_keys(SMALL_KEY_WATER, 2) or has_skeleton_key_oot() end,
        },
    },
    ["Water Temple Antichamber"] = {
        ["exits"] = {
